...
// func TestKeeper_GetRecords_Error(t *testing.T) {
// 	app, ctx := test.CreateTestApp(false)
// 	keeper := app.DispensationKeeper
// 	outList := test.CreatOutputList(3, "1000000000")
// 	name := uuid.New().String()
...
// 	list := keeper.GetRecords(ctx)
// 	t.Log(list)
// 	iterator := keeper.GetDistributionRecordsIterator(ctx.WithBlockHeight(int64(0)), types.DistributionStatus_DISTRIBUTION_STATUS_PENDING)
// 	t.Log(iterator)
...
// func TestKeeper_ChangeRecordStatus_ErrorInDeletingRecord(t *testing.T) {
// 	app, ctx := test.CreateTestApp(false)
// 	keeper := app.DispensationKeeper
// 	outList := test.CreatOutputList(3, "1000000000")
// 	name := uuid.New().String()
...
// 		err1 := keeper.ChangeRecordStatus(ctx, record, ctx.BlockHeight(), types.DistributionStatus_DISTRIBUTION_STATUS_PENDING)
// 		assert.NoError(t, err1)
// 		err := keeper.SetDistributionRecord(ctx, record)
// 		assert.NoError(t, err)
// 		err2 := keeper.DeleteDistributionRecord(ctx, "record.DistributionName", record.RecipientAddress, record.DistributionStatus, record.DistributionType) // Delete the record in the pending prefix so the iteration is cheaper.
// 		t.Log(err2)
// 	}
// }
