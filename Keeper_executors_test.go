...
// func TestKeeper_CreateDrops(t *testing.T) {
// 	app, ctx := test.CreateTestApp(false)
// 	keeper := app.DispensationKeeper
// 	outputAmount := "10000000000000000000"

// 	outputList := test.CreatOutputList(3, outputAmount)
// 	distributionName := sdk.AccAddress("addr1_______________").String()
// 	runner := sdk.AccAddress("addr1_______________").String()
// 	err1 := keeper.CreateDrops(ctx, outputList, distributionName, types.DistributionType_DISTRIBUTION_TYPE_UNSPECIFIED, runner)
// 	t.Log(err1)

// 	for _, receiver := range outputList {

// 		distributionRecord := types.NewDistributionRecord(types.DistributionStatus_DISTRIBUTION_STATUS_PENDING, types.DistributionType_DISTRIBUTION_TYPE_UNSPECIFIED, "", receiver.Address, receiver.Coins, ctx.BlockHeight(), -1, "")
// 		t.Log(distributionRecord)
// 		if keeper.ExistsDistributionRecord(ctx, distributionName, receiver.Address, types.DistributionStatus_DISTRIBUTION_STATUS_PENDING, distributionRecord.DistributionType) {
// 			oldRecord, err := keeper.GetDistributionRecord(ctx, distributionName, receiver.Address, types.DistributionStatus_DISTRIBUTION_STATUS_PENDING, distributionRecord.DistributionType)

// 			t.Log(oldRecord)
// 			t.Log(err)

// 		}
// 		err := keeper.SetDistributionRecord(ctx, distributionRecord)
// 		t.Log(err)
// 	}
// }
...
func TestKeeper_VerifyDistribution_unable(t *testing.T) {
	app, ctx := test.CreateTestApp(false)
	keeper := app.DispensationKeeper
